...
// Guards against every "meant to be empty" representation your platform might send
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      fields_updated: Object.keys(patchBody), // handy for debugging/confirmation messages
    });
